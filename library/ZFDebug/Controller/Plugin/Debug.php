    ...
    protected function _headerOutput() {
        ...
        return ('
            <style type="text/css" media="screen">
                #ZFDebug_debug { font: 13px/1.4em Lucida Grande, Lucida Sans Unicode, sans-serif; position:fixed; bottom:5px; left:5px; color:#cfcfcf; z-index: ' . $this->_options['z-index'] . ';background:#bfbfbf}
                #ZFDebug_debug ol {margin:10px 0px; padding:0 25px}
                #ZFDebug_debug li {margin:0 0 10px 0;}
                #ZFDebug_debug .clickable {cursor:pointer}
                #ZFDebug_toggler { font-weight:bold; background:#222222; }
                .ZFDebug_span { border: 1px solid #424242; border-right:0px; background:#222222; padding:7px 13px}
                .ZFDebug_last { border: 1px solid #424242; }
                .ZFDebug_panel { text-align:left; position:absolute;bottom:33px;width:834px; max-height:400px; overflow:auto; display:none; background:#121212; padding:5px; border: 1px solid #424242; }
                .ZFDebug_panel .pre {font: 11px/1.4em Monaco, Lucida Console, monospace; margin:0 0 0 22px}
                #ZFDebug_exception { border:1px solid #424242;display: block; }
                #ZFDebug_info span {float:left}
                #ZFDebug_info img {
                    float: left;
                    margin-right: 4px;
                }
